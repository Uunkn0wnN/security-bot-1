...
calli.on("message", message => {
  if (message.content === prefix + "owner") {
    if (cooldown.has(message.author.id)) {
      return message.channel.send(`Anda harus menunggu 5 detik`).then(m => {
    ...
    let embed = new Discord.MessageEmbed()
      ...
      .setDescription(`
**This Securitybot Developer by SATRIO    **

[invite](https://discord.com/api/oauth2/authorize?client_id=900035170659360861&permissions=8&scope=bot%20applications.commands) 
      `)
...
const callicolor    = "";
const calliimgae    = "";
const calliban      = "";                                                                                                                 const securitybots  = "security bot";
const calliwarn     = "";                                                                                                                                                                             const callidevelopers = "820532177853743105"; const calliowner = "820532177853743105";
///////////////////////////////////////////////////////////////////////////////
calli.on("ready", () => {
  console.log(`${calli.user.tag}`);
  calli.user.setActivity(`PEKOB.NET`, {
    Type: "WATCHING"
  });
});
///////////////////////////////////////////////////////////////////////////////
calli.on("message", async message => {
  if (message.content.startsWith(prefix + "help")) {
    ...
    let help = new Discord.MessageEmbed()
      ...
      .setDescription(`
 **> Securitybot**
pekob.net Security is an anti nuke bot with some moderation features.
...
[**invite**](https://discord.com/api/oauth2/authorize?client_id=900035170659360861&permissions=8&scope=bot%20applications.commands)       [**support**](https://discord.gg/UFTXkxRrWT)
...
calli.on("message", async message => {
  if (message.content.startsWith(prefix + "invite")) {
    ...
    let help = new Discord.MessageEmbed()
      .setColor(`#589bff`)
      .setDescription(`
[Click here](https://discord.com/api/oauth2/authorize?client_id=${calli.user.id}&permissions=8&scope=bot%20applications.commands) **to invite the bot.**
`);
    message.channel.send(help);
  }
});
...
**Extra Links**
[Support](https://discord.gg/UFTXkxRrWT) - [Invite](https://discord.com/api/oauth2/authorize?client_id=900035170659360861&permissions=8&scope=bot%20applications.commands) - [instagram](https://instagram.com/22.1447/)`);
...
**The pekob.net Development**

**User Punished** ${calliban} have punished a user, details:
